...
proj=crs.LambertConformal(121,25)
ax = fig.add_subplot(1,1,1,projection=proj) #子圖位置
...
plt.title("%s-%s-%s 24:00 tempreture"%(year,mon,day))
plt.savefig(r".\temp.png") #存圖，只能存程png
plt.show()
